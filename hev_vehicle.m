...
% Vehicle Parameters
Drim = 17*in2m;         % Rim Diameter [m]
width_tyre = 0.22606;  % Tyre Width [m]
height_tyre = 70;       % Tyre Height [%]
Jwheel = 2.047;           % Wheel Inertia [kg.m^2]
% Mveh = 1378.92;       % Static Vehicle Mass [kg] 

f_fric = 0.01;          % Coulomb Friction Coefficient
k_fric = 0;             % Viscous Friction Coefficient
wind_fric = 0;          % Windage Coefficient
Cdrag = 0.4;           % Aerodynamic Drag Ceofficient
% Cdrag = 0.3;
...
Faero = 0.5*rho_air*Cdrag*Sveh*(Vveh+Vwind).^2;  % Areodynamic Drag Forve
